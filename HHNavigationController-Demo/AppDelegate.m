...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    HHNavigationController *secondVC = [[HHNavigationController alloc] initWithRootViewController:[[ViewController alloc] init]];
    secondVC.tabBarItem.title = @"second";
    barVC.viewControllers = @[firstVC, secondVC];
